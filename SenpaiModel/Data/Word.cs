...
namespace SenpaiModel
{
    public class Word : LessonItem
    {
        ...
        [JsonIgnore] public override string Content => ToString();
        [JsonIgnore] public override string Details => ToDescriptionString();
        ...
        {
            EVocabType type = VocabType;

            if (Description != "")
            {
                if (VocabType == EVocabType.Other)
                {
                    return Description;
                }
                
                return type.TypeStr + " - " + Description;
            }
            return type.TypeStr;
        }
        ...
        public override void Reset()
        {
            ...
            ShowWord = EVisibilityType.ShowBoth;
        }
